 ...
 */
let candy = "ореховая"
let unknowCandyColor = "желтого"  // сюда ввести цвет конфеты

let redCandyColor = "красный"
let yellowCandyColor = "желтого"
let brownCandyColor = "коричневого"
let greenCandyColor = "зеленого"

switch candy {
case "шоколадная" where unknowCandyColor == redCandyColor: print("это шокололадная конфета красного цвета")
case "ореховая" where unknowCandyColor == yellowCandyColor || unknowCandyColor == greenCandyColor : print("это ореховая конфета желтого или зеленого цвета")
default:
    print ("Я не знаю что это за конфета и куда её положить")
}
