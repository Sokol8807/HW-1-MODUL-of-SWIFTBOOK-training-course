 ...
 */
let daysPassed: Float = (Float(myAgeInTenYears) + Float(myAge)) * Float(daysInYear)
 ...
 */
print("Мой возраст \(myAge) года. Через 10 лет, мне будет \(myAgeInTenYears) года, с момента моего рождения пройдет \(Int(daysPassed)) дней.")
